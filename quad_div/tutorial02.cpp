...
int main( void )
{
    ...
    static GLfloat g_size = grid_size;
    ...
    GLfloat feedback[grid_size*grid_size*2];
    ...
    GLuint programID2 = LoadShaders( "SimpleVertexShader.glsl", "SimpleFragmentShader.glsl", "SimpleGeometryShader.glsl");
...
//    glBufferData(GL_ARRAY_BUFFER, sizeof(g_vertex_buffer_data), g_vertex_buffer_data, GL_STATIC_DRAW);
    ...
    // TODO: Transform feedback to divide quads close to the center into 4 different quads
    // Need: new Geometry shader, new vertex shader,
    ...
    do{
        ...
        // Draw the quads
        glDrawArrays(GL_POINTS, 0, grid_size*grid_size); // 3 indices starting at 0 -> 1 triangle
